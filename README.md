...
### Modのインストール
 ...
 - つぎに [Mod.zip](https://github.com/RR96ne/palworld-chat-logger/releases/tag/v1.1.0)をダウンロードして解凍し、
   {パルワールドのインストールフォルダ}\Pal\Binaries\Win64\Mods\の中に解凍したChatLoggerModフォルダごと入れます。
### Viewerのインストール
 - [Viewer.zip](https://github.com/RR96ne/palworld-chat-logger/releases/tag/v1.1.0)をダウンロードして解凍し、
